...
function openLetter() {
  playWipeTransition(() => {
    ...
    if (isEpilogue) {
      ...
      // ---------- Foto khusus epilogue (img/epilogue1.jpg) — file
      // terpisah dari img/hbd1.png biar nggak ada nuansa ultah (topi,
      // tulisan "Happy Birthday", dst) pas dibuka di luar musim. ----------
      if (imgEl) {
      ...
      if (imgEl) { imgEl.src = "./img/hbd1.png?v=4"; imgEl.alt = "Kenangan kecil"; }
      if (imgLabelEl) imgLabelEl.textContent = "a little memory ♡";
    }
...
function getBirthdayCycleState(now = new Date()) {
