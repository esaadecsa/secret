...
/* ---------- REFRESH PLAYLIST SESUAI TANGGAL SIMULASI — dipanggil dari
   ...
   - Urutan/label di daftar playlist SELALU di-render ulang, di layar mana
     ...
     playlist.
   - Lagu yang SEDANG diputar hanya ikut ditukar kalau pengunjung masih di
     layar PIN DAN belum pernah pilih lagu sendiri (masih lagu default
     otomatis) — begitu dia sudah pilih manual atau sudah lanjut ke slide
     berikutnya, lagu yang sedang main dibiarkan apa adanya, cuma urutan
     daftarnya yang diperbarui. ---------- */
function refreshPlaylistForDate() {
  ...
  if (!songManuallyChanged && currentScreen === "pin") {
    // Belum pernah dipilih manual & masih di layar PIN — aman untuk
    // menukar lagu default yang sedang otomatis diputar.
  ...
  // Sudah pernah dipilih manual atau sudah lanjut ke slide berikutnya —
  // jangan ganggu lagu yang sedang main. Cuma cari ulang index-nya di
  // daftar baru (posisinya bisa geser kalau lagu yang sedang main adalah
  // salah satu dari Panjang Umur/Untouchable) supaya tanda "sedang
  // diputar"/"dipilih" tetap nempel ke lagu yang benar.
  if (currentSongId) {
